...
seed_ss = SamApp2024.stockholm_ss(natural_seed_stk.out)
...
pos_align = SamApp2024.shape_positions_alignment_2022()
...
synthetic_df = CSV.read(SamApp2024.pierre20221107post(:synthetic), DataFrame)
