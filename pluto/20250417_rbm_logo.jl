...
msa = SamApp2024.rfam_RF00162_hits()
...
seqlogo_entropic(reshape(mean(SamApp2024.rbm2022samples(); dims=3), 5, 108)).fig

# ╔═╡ 82d312e7-4a3c-4594-a26b-317a7c64b1c2
seqlogo_entropic(reshape(mean(SamApp2024.onehot(msa); dims=3), 5, 108)).fig
