...
aptamer_rbm_energies_500 = free_energy(SamApp2024.rbm2022(), SamApp2024.onehot(shape_data_500.aligned_sequences));
...
aptamer_natural_distances_500 = SamApp2024.hamming(SamApp2024.onehot(shape_data_500.aligned_sequences), SamApp2024.onehot(RF00162_hits));

# ╔═╡ bdec681b-179f-4e7e-9b5d-b2a4ca01d5af
aptamer_natural_distances_rep0 = [ismissing(seq) ? missing : minimum(SamApp2024.hamming(SamApp2024.onehot(LongRNA{4}(seq)), SamApp2024.onehot(RF00162_hits))) for seq = shape_data_045.aligned_sequences];
